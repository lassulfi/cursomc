...
import com.luisassulfi.cursomc.services.validation.ClienteInsert;
...
public class ClienteNewDTO implements Serializable {
	...
	@NotEmpty(message="Campo cpfOuCnpj deve ser preenchido")
	private String cpfOuCnpj;
	
	private Integer tipo;
	
	@NotEmpty(message="Campo logradouro deve ser preenchido")
	...
	@NotEmpty(message="Campo telefone 1 deve ser preenchido")
